...
$query = "SELECT o.OrderID, o.Date, o.OrderProductName AS ProductName, o.OrderValue AS TotalValue,
 c.Name AS CustomerName, c.Phone AS CustomerPhone, c.Email AS CustomerEmail, c.Address AS CustomerAddress, o.OrderProductImage as ProductImage
