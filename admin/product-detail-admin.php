        ...
        <div class="row d-flex justify-content-center">
          <div class="col-md-5 mx-5">
            <img
              src=""
              alt=""
              class="img-fluid product-head-image"
              id="image-product"
            />
          </div>
          <div class="col-md-5 mt-md-3 mt-sm-3 mt-3">
            ...
            <div class="d-flex flex-column align-items-center mt-4">
              <button
                class="btn btn-success open-edit-modal page-button"
                id="edit-button"
              >
                Edit
              </button>
              <hr />
              <button
                class="btn btn-danger open-delete-modal page-button"
                id="delete-button"
              >
                Delete
              </button>
              ...
              <div class="edit-form d-flex flex-row mx-2">
                <div class="flex-fill">
                  ...
                  <form class="edit-product-form" id="edit-product-form" method="POST">
                    ...
                    <!-- <div class="form-group mb-2">
                      <label for="detail" class="mb-1 label-edit"
                        >Detail:</label
                      >
                      <input
                        type="text"
